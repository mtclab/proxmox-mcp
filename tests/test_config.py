...
class TestConfigFromEnv:
    def test_valid_config(self, env_vars: dict[str, str]) -> None:
    ...
    def test_missing_url(self, env_vars: dict[str, str]) -> None:
        env = {k: v for k, v in env_vars.items() if k != "PROXMOX_URL"}
        with patch.dict(os.environ, env, clear=True):
            with pytest.raises(ValueError, match="PROXMOX_URL is required"):
                Config.from_env()

    def test_missing_monitor_token_id(self, env_vars: dict[str, str]) -> None:
    ...
    def test_missing_monitor_token_secret(self, env_vars: dict[str, str]) -> None:
    ...
    def test_missing_admin_token_id(self, env_vars: dict[str, str]) -> None:
    ...
    def test_missing_admin_token_secret(self, env_vars: dict[str, str]) -> None:
