...
async def get_user_tfa(client: MultiClient, userid: str = "",
...
async def get_tfa_entry(client: MultiClient, userid: str = "", id: str = "",
    endpoint: str | None = None) -> str:
    ep = endpoint or client.default_endpoint
    if not userid:
        raise ValueError("userid is required")
...
async def get_domain(client: MultiClient, realm: str = "",
    endpoint: str | None = None) -> str:
    ep = endpoint or client.default_endpoint
    if not realm:
...
async def get_user_tfa_types(client: MultiClient, userid: str = "",
    endpoint: str | None = None) -> str:
    ep = endpoint or client.default_endpoint
    if not userid:
        raise ValueError("userid is required")
...
async def openid_auth_url(client: MultiClient, realm: str = "",
    endpoint: str | None = None) -> str:
    ep = endpoint or client.default_endpoint
    if not realm:
        raise ValueError("realm is required")
...
async def openid_login(client: MultiClient, realm: str = "", code: str = "", state: str = "",
    endpoint: str | None = None) -> str:
    ep = endpoint or client.default_endpoint
    if not realm:
        raise ValueError("realm is required")
